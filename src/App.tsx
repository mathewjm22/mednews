          ...
          <div className="w-full">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                ...
                <p className="text-slate-600 mt-2">Aggregated from your configured medical feeds.</p>
              </div>
              <button
                onClick={() => setShowSettings(true)}
                className="text-sm text-blue-600 hover:text-blue-800 flex items-center gap-1 bg-blue-50 px-3 py-1.5 rounded-full border border-blue-100 self-start sm:self-auto"
              >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                {rssArticles.map((article, index) => (
                  <motion.div
                    ...
                    className="bg-white border border-orange-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all cursor-pointer flex flex-col group h-full"
                  >
                    {article.imageUrl && (
                      <div className="w-full h-40 shrink-0 border-b border-slate-100">
                        <img
                    ...
                    <div className="p-4 sm:p-5 flex-1 flex flex-col">
                      <div className="flex items-center gap-2 mb-3 flex-wrap">
                        <span className="text-xs font-bold uppercase tracking-wider text-white bg-slate-800 px-2 py-1 rounded shadow-sm">
                          {article.journal}
                        </span>
                      ...
                      <h3 className="text-base font-bold text-slate-900 leading-snug mb-2 group-hover:text-blue-700 transition-colors line-clamp-3">
                        {article.title}
                      </h3>
                      ...
                      <div className="mt-auto pt-3 border-t border-slate-50 flex justify-between items-center">
                        ...
                        <a
                          ...
                          className="inline-flex items-center justify-center p-1.5 bg-slate-50 text-slate-500 rounded hover:bg-orange-50 hover:text-orange-600 transition-colors"
                        ...
                        {expandedArticleId === article.id && (
                          ...
                          >
                            <div className="mt-3 pt-3 border-t border-slate-100">
                              {article.abstract ? (
                                <div
                                  className="text-[13px] text-slate-700 leading-relaxed font-serif"
